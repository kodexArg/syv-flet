...
description: Review code against SyV-Flet standards and SOLID principles. Use when reviewing Python code, implementing features, refactoring, or ensuring architectural compliance with mandatory standards.
allowed-tools: Read, Grep, Edit, Bash
---

# SyV-Flet Code Standards Review
